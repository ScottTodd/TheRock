...
* Clones the pytorch repository into `src/` with a requested `--repo-ref`
...
REPO_NAME = "pytorch"
PATCHES_DIR = THIS_DIR / "patches" / REPO_NAME
...
def main(cl_args: list[str]):
    ...
    checkout_p.add_argument(
        "--repo-ref", default=default_ref, help="PyTorch ref/tag to checkout"
    )
